...
export default class Brakes extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <div id="brakes">
                <Row>
                    <h1>Brakes</h1>
                    <Image style={{ "width": "100%", "cursor": "pointer" }} src='/img/carbrakes.jpg' onClick={() => this.setState({ isOpen: true, photoIndex: 4 })}></Image>
